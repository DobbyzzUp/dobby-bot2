...
global.mods = ['19086234869@s.whatsapp.net']
global.prems = ['19086234869@s.whatsapp.net']
ownernumber=
['19086234869@s.whatsapp.net']

global.dfail = (type, m, conn) => {
  let msg = {
    owner: '⚡Comando exclusivo do adm 𝐷𝑂𝐵𝐵𝑌♱᭄⚡',
    mods: '⚡Comando exclusivo do adm 𝐷𝑂𝐵𝐵𝑌♱᭄⚡',
    premium: '⚡Comando exclusivo do adm 𝐷𝑂𝐵𝐵𝑌♱᭄⚡',
    group: '⚡Comando disponivel apenas em grupos⚡',
    private: '⚡Comando disponivel apenas no pv⚡',
    admin: '⚡Comando disponivel apenas para adms. Seu membro comum 😡 ',
    botAdmin: '⚡O bot deve ser admin!⚡'
  }[type]
